...
import lostBattleImage from "/assets/lost-battle.jpg";
...
export const LostBattle: React.FC<Props> = ({ className }) => {
  ...
  return (
    <div className={cn("w-full h-full flex flex-col items-center", className)}>
      ...
      <div className="text-center">
        <h2 className="font-medium text-[24px] leading-[135%]">You Lost!</h2>

        <h1 className="text-[32px] font-bold leading-[135%]">
          -{formatBalance(500)} $GAI
        </h1>
      </div>
